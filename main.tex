...
\end{tabular}
	...
	\begin{abstract} 
		Concise summary of objectives, methods, key findings, and conclusions.
	\end{abstract}
...
This assessment compares three distinct emergency shelter power solutions:
	...
	\end{itemize}
The selection encompasses both mature and emerging technologies to provide a balanced perspective on sustainability trade-offs in disaster response applications.\\[8pt]
By comparing perovskite-integrated shelters with traditional options, this work seeks to evaluate the potential benefits and trade-offs in their use during disaster response scenarios.
