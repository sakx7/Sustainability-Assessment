...
\textbf{Goal:} Explain the purpose of the environmental assessment. For example, “To compare the environmental impacts of perovskite-integrated shelters, silicon solar-equipped shelters, and diesel generators.”\\
\textbf{Scope:} Define the boundaries of the assessment (e.g., cradle-to-grave or gate-to-gate, life cycle stages considered, cut-off points for data).
